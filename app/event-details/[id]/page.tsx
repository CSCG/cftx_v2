import { api } from '@/lib/axios';
    ...
    export async function generateStaticParams() {
      try {
        ...
        console.error('Failed to fetch events for static params:', error);
        return [];
      }
    }
    ...
    export default async function EventDetailsPage({
      ...
      const ticketTiers = await getTicketTiers(params.id);

      if (!event) {
        notFound();
      }

      // Check for essential properties before rendering
      if (
        !event.id ||
        !event.event_name ||
                  ...
                  {ticketTiers.map((tier) => (
                    ...
                    >
                      ...
                      <Button
                        asChild
                      >
                        <a href={`https://www.cedarfallsdata.com/event/${params.id}/${tier.id}/purchase`}>
                          Purchase Ticket
                        </a>
                      </Button>
                    </div>
